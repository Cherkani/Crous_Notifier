  ...
  const renderWatches = () => (
    <section className="grid two">
      <Card title="Crous search setup" icon={<Plus size={18} />}>
        <p className="section-note">Configure the Crous search URL here. Receivers are managed separately in Configuration, so changing a number or email updates future sends.</p>
